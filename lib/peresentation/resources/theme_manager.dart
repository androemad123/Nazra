...
class ThemeManager {
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme:  TextTheme(
      ...
      titleLarge: TextStyle(color: ColorManager.black, fontWeight: FontWeightManager.semiBold),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: ColorManager.white, fontWeight: FontWeight.bold),
    ),
