...
class ColorManager {
  // Light Mode Colors
  static const Color brown = Color(0xFFA57E4C);
  static const Color lightBrown = Color(0xFFCBAA7D);
  ...
  static const Color darkLightBrown = Color(0xFF9C835C);
  static const Color darkCream = Color(0xFF4A3A28);
